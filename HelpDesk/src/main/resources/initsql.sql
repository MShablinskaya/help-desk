...
DROP TABLE IF EXISTS PUBLIC.USERS_TICKETS;
...
(
    ...
    CONSTRAINT USER_TICKET_ID_FOREIGN_KEY FOREIGN KEY (TICKET_ID) REFERENCES TICKET (ID),
    CONSTRAINT TICKET_OWNER_FOREIGN_KEY FOREIGN KEY (USER_ID) REFERENCES USER (ID)
);
