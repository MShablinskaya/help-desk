...
INSERT INTO USER (FIRST_NAME, LAST_NAME, ROLE_ID, EMAIL, PASSWORD) VALUES ( 'JOHN','DOE', 'EMPLOYEE', 'user1_mogilev@yopmail.com', '$2a$04$Xk8sj79QuXkNaAN9rxBSw.Fnf1vM4FS5qHWXMip7PsDqUK2utnUcm' );
INSERT INTO USER (FIRST_NAME, LAST_NAME, ROLE_ID, EMAIL, PASSWORD) VALUES ( 'JANE','DOE', 'EMPLOYEE', 'user2_mogilev@yopmail.com', '$2a$04$uewDgHbFOXoXUkqs2ve2p.1lDkX.MWTn.yuwSdibq0oQ5KIsRIbnG' );
INSERT INTO USER (FIRST_NAME, LAST_NAME, ROLE_ID, EMAIL, PASSWORD) VALUES ( 'ELVIS','PRESLEY', 'MANAGER', 'elvistheking@yopmail.com', 'zxcvb123' );
